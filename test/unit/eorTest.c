...
void test_eor_im(void) {
    const Byte checkValue = 0b01111111;

    cpu.A = 0b10000110;

    memory.data[0] = inst.EOR_IM.opcode;
    memory.data[1] = 0b11111001;
...
void test_eor_indexed_indirect(void) {
    const Byte checkValue = 0b01111111;
...
void test_eor_indirect_indexed(void) {
    const Byte checkValue = 0b01111111;
...
int main(void)
{
    ...
    RUN_TEST(test_eor_im);
    RUN_TEST(test_eor_zeropage);
    RUN_TEST(test_eor_zeropage_x);
    RUN_TEST(test_eor_absolute);
    RUN_TEST(test_eor_absolute_x);
    RUN_TEST(test_eor_absolute_y);
    RUN_TEST(test_eor_indexed_indirect);
    RUN_TEST(test_eor_indirect_indexed);
